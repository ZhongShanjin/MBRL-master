...
class PostProcessor(nn.Module):
    ...
    def forward(self, x, rel_pair_idxs, boxes, targets):
        """
        Arguments:
...
def make_roi_relation_post_processor(cfg):
    attribute_on = cfg.MODEL.ATTRIBUTE_ON  # F
    use_gt_box = cfg.MODEL.ROI_RELATION_HEAD.USE_GT_BOX  # T
    use_confusion = cfg.Confusion
    later_nms_pred_thres = cfg.TEST.RELATION.LATER_NMS_PREDICTION_THRES  # 0.5
    inference = cfg.TEST.INFERENCE  # softmax
